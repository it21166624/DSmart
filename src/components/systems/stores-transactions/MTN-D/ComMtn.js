...
const EnhancedTableToolbar = (props) => {
    const { numSelected, handleAddNewMTN } = props;
    ...
    return (
        ...
        >
            ...
            <Box sx={{ flex: '1 1 100%' }} />
            <Button variant="contained" onClick={handleAddNewMTN} sx={{ marginLeft: 'auto', whiteSpace: 'nowrap' }}>
                Add New MTN
            </Button>
    ...
    return (
        ...
        <Box>
            <Box sx={{ mt: 10, ml: 2, mb: -7 }}>
                <Typography variant="h6">MTN Details</Typography>
            </Box>
            <Box>
                <EnhancedTableToolbar
                    ...
                    handleAddNewMTN={handleAddNewMTN}
                />
