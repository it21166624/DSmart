...
const EnhancedTableToolbar = (props) => {
    const { numSelected, handleAddNewMRQ } = props;
    ...
    return (
        ...
        >
            ...
            <Box sx={{ flex: '1 1 100%' }} />
            <Button variant="contained" onClick={handleAddNewMRQ} sx={{ marginLeft: 'auto', whiteSpace: 'nowrap' }}>
                Add New MRQ
            </Button>
...
const ComMrq = () => {
    ...
    const handleAddNewMRQ = () => {
        console.log('Add New MRQ button clicked');
        // logic
    };
    ...
    return (
        ...
        <Box>
            <Box sx={{ mt: 10, ml: 2, mb: -7 }}>
                <Typography variant="h6">MRQ Details</Typography>
            </Box>
            <Box>
                <EnhancedTableToolbar
                    ...
                    handleAddNewMRQ={handleAddNewMRQ}
                />
